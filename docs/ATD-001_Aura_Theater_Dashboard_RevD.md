...
| Supersedes | ATD-001 v0.3 RevC |
| Status | PRESERVED DESIGN LAW. Amended per pre-build review ruling of 2026-06-07 (dual counter, flicker doctrine). |
| Vault Path | AUMX-VAULT / Scroll School / public / ATD-001_Aura_Theater_Dashboard_RevD.md |
...
| GATE | Confirm, Seal, Register | White and gold (seal), purple (register) | Spine only | May never appear off-spine. Ceremonial. |
...
Trigger: seal_completed. The only producer of gold in the system.

1. The confirmed diamond or node brightens to full white.
2. A ring closes around it.
3. The spine brightens white along its full length.
4. One restrained white-gold pulse. Short. Clean.
5. Geometry stabilizes and holds white.
6. Ledger entry: SEALED, with item and timestamp.
...
End of ATD-001 v0.4 RevD. Preserved as design law. Build authority flows through ATD-002 RevB.
